  ...
  try {
    ...
    switch(goal_id) {
       case 1  :
          ...
          q_goal = {{-0.04680685289753111, -0.362919943885248, 0.12212396493397261, -1.9891788963681636, 0.049119972106605785, 1.6763869404792788, 0.9134802083994287}};
          break;


       case 2  :
        std::cout << "Selected q_grasping_region as goal" << std::endl;
          q_goal = {{-0.3118836220674799, 0.12208836340799667, -0.3792996648491939, -1.4533498636510371, 0.04823385863952512, 1.5948859413464864, 0.15217954139437748}};
          break;
