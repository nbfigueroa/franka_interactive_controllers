# https://github.com/justagist/franka_ros_interface/blob/master/franka_interface/src/franka_interface/gripper.py
# /***************************************************************************
...
class GripperInterface(object):
    ...
    def __init__(self, gripper_joint_names = ('panda_finger_joint1', 'panda_finger_joint2'), calibrate = False, **kwargs):
        ...
        try:
            ...
            # rospy.loginfo('/franka_gripper/robot_ip is %s', rospy.resolve_name('/franka_gripper/robot_ip'), value)
        except KeyError:
        ...
        # This kind of takes ages... but seems to work
